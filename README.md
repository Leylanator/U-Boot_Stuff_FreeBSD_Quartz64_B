...
```
This will make a selected SD card be the boot device.
...
The recommended method of install is currently to flash the A-Model's image, and then swap out some boot files for the ones the Model B uses. That's obviously a bit different.
